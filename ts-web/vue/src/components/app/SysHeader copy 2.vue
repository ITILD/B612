<template>
  ...
  <header class="bg-white border-gray-200 dark:border-gray-600 dark:bg-gray-900">
    ...
    <!-- <Transition  enter-active-class="transition duration-3000 ease-in" enter-from-class="opacity-0"
      enter-to-class="opacity-50"> -->
    <!--无->有 enter-active-class 动画动作时间   -->
    <transition enter-active-class="duration-1000 ease-in" enter-from-class="transform opacity-0"
      enter-to-class="opacity-100" leave-active-class="duration-1000 ease-in" leave-from-class="opacity-100"
      leave-to-class="transform opacity-0">
      <div v-if="showFun" id="mega-menu-full-image-dropdown"
        class="z-10 absolute mt-1 bg-white border-gray-200 shadow-sm border-y dark:bg-gray-800 dark:border-gray-600">
        <div
