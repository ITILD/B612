  ...
  <ul class="grid grid-cols-1 md:grid-cols-8">
    <li>
      <div class="w-full aspect-[9/5] md:aspect-[9/16]">
        <canvas ref="canvasRef0" id="webgldom" class="w-full h-full"></canvas>
      </div>
      <p>
        <span>.base</span>
      </p>
...
const initWebgl = () => {
  ...
  // 1.获取webgl
  const canvasRef0 = ref<null | HTMLCanvasElement>(null)
  let canvas =canvasRef0.value as HTMLCanvasElement
